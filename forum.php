                                        ...
                                        <p class="badge <?= $categoryClass ?>"><?= htmlspecialchars($post['category']) ?></p>
                                            ...
                                            <div class="list-comment col-md-2">
                                                <div class="comment-badge-container">
                                                    ...
                                                    <!-- Comment Count Badge -->
                                                    <div class="comment-count-badge" data-count="<?= htmlspecialchars($post['comment_count']) ?>">
                                                        <?= $post['comment_count'] > 99 ? '99+' : htmlspecialchars($post['comment_count']) ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="list-meta mb-1">
                                ...
                                <div class="list-comment col-md-2">
                                    <div class="comment-badge-container">
                                        ...
                                        <!-- Comment Count Badge -->
                                        <div class="comment-count-badge" data-count="${post.comment_count}">
