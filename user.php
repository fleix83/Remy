                            ...
                            <div class="user-draft-post d-flex flex-column justify-content-between align-items-start mb-3">
                                ...
                                <div>
                                    ...
                                    <form action="publish_draft_process.php" method="post" class="d-inline-block">
                                        <input type="hidden" name="draft_id" value="<?= htmlspecialchars($draft['id']) ?>">
                                        <button type="submit" class="btn btn-primary action-butto-primary">Veröffentlichen</button>
                                    </form>
                                </div>
                            </div>
                        <?php endforeach; ?>
                    ...
                    <?php foreach ($posts as $post): ?>
                        <div class="user-post-post d-flex flex-column mb-3">
                            ...
                            <div class="float-left mb-2">
                                <span class="badge bg-erfahrung me-2"><?= htmlspecialchars($post['category_name'] ?? 'Uncategorized') ?></span>
